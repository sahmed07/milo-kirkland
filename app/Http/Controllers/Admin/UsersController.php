...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        $cities = \App\City::get()->pluck('city_name', 'id');
    ...
    public function show($id)
    {
        ...
        $user_actions = \App\UserAction::where('user_id', $id)->get();$internal_notifications = \App\InternalNotification::whereHas('users',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$payments = \App\Payment::where('created_by_id', $id)->get();$profiles = \App\Profile::where('created_by_id', $id)->get();$pets = \App\Pet::where('created_by_id', $id)->get();

        $user = User::findOrFail($id);

        return view('admin.users.show', compact('user', 'user_actions', 'internal_notifications', 'payments', 'profiles', 'pets'));
    }
