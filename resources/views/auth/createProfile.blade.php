...
@section('content')
    <h3 class="page-title">Hello {{ Auth::user()->name }}, your account created successfully.<br> Please create your profile to complete the registration. </h3>
    <h3 class="page-title">@lang('global.profile.title')</h3>
    {!! Form::open(['method' => 'POST', 'route' => ['auth.createProfile']]) !!}
    
<!--    <form action="/auth/createProfile" method="post">   -->
    ...
    {!! Form::submit(trans('global.app_addPetNow'), ['class' => 'btn btn-danger', 'name' => 'submitbutton']) !!}
    {!! Form::submit(trans('global.app_addPetLater'), ['class' => 'btn btn-danger', 'name' => 'submitbutton']) !!}
    {!! Form::close() !!}
@stop
