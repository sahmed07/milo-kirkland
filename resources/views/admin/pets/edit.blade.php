...
@section('content')
    ...
    {!! Form::model($pet, ['method' => 'PUT', 'route' => ['admin.pets.update', $pet->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($pet->pet_photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$pet->pet_photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$pet->pet_photo) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('microchip', $enum_microchip, old('microchip'), ['class' => 'form-control select2']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($pet->getMedia('microchip_file') as $media)
                                <p class="form-group">
                                    <a href="{{ $media->getUrl() }}" target="_blank">{{ $media->name }} ({{ $media->size }} KB)</a>
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Remove</a>
                                    <input type="hidden" name="microchip_file_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('rabies_vacc', $enum_rabies_vacc, old('rabies_vacc'), ['class' => 'form-control select2']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        <div class="progress-bar form-group">&nbsp;</div>
                        <div class="files-list">
                            @foreach($pet->getMedia('rabies_vacc_file') as $media)
                                <p class="form-group">
                                    <a href="{{ $media->getUrl() }}" target="_blank">{{ $media->name }} ({{ $media->size }} KB)</a>
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Remove</a>
                                    <input type="hidden" name="rabies_vacc_file_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
