...
@section('content')
    ...
    {!! Form::model($profile, ['method' => 'PUT', 'route' => ['admin.profiles.update', $profile->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('address_latitude', $profile->address_latitude , ['id' => 'address-latitude']) !!}
                    {!! Form::hidden('address_longitude', $profile->address_longitude , ['id' => 'address-longitude']) !!}
                    <p class="help-block"></p>
