                ...
                <tr data-entry-id="{{ $faq_question->id }}">
                    <td field-key='category'>{{ $faq_question->category->title or '' }}</td>
                                ...
                                <td field-key='answer_text'>{!! $faq_question->answer_text !!}</td>
                                                                <td>
                                    @can('view')
                                    <a href="{{ route('faq_questions.show',[$faq_question->id]) }}" class="btn btn-xs btn-primary">@lang('global.app_view')</a>
                                    @endcan
                                    @can('edit')
                                    <a href="{{ route('faq_questions.edit',[$faq_question->id]) }}" class="btn btn-xs btn-info">@lang('global.app_edit')</a>
                                    @endcan
                                    @can('delete')
{!! Form::open(array(
